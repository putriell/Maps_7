...
import com.example.maps_7.databinding.ActivityMapsBinding;
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
        ...
        LatLng VokasiUGM = new LatLng(-7.7694626, 110.3703694);
        mMap.addMarker(new MarkerOptions().position(VokasiUGM).title("Marker in Vokasi"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(VokasiUGM, 100));
